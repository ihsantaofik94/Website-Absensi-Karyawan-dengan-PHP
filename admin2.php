        ...
        <div class="page-container">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <h1>Sistem Absensi Karyawan DEVANODA</h1>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <center><img src="assets/img/Logo-DEVanoda.png" width="300" class="img img-responsive" height="500"></center><br>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2022 . All rights reserved. Template by <a href="">Liska Ismawati</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
